<template>
  <div id="page2">
    <div id="content" data-spm-anchor-id="a2107.1.0.i0.6f7ecvoRcvoR0R">
      <div id="J_LoginBox" class="login-box no-longlogin module-static">
        ...
        <div class="bd">
          ...
          <div class="static-form" id="J_StaticForm">
            ...
            <form
              action="/member/login.jhtml?redirectURL=https%3A%2F%2Fwww.tmall.com%2F"
              method="post"
              id="J_Form"
            >
              ...
              <div class="submit">
                ...
                <input
                  ...
                  type="hidden"
                  name="ncoToken"
                  value="6fbc28397abf1abaec2513d91ff12115ff4e2437"
                />
                ...
                <input
                  type="hidden"
                  id="J_TPL_redirect_url"
                  name="TPL_redirect_url"
                  value="https://www.tmall.com/"
                />
                <input type="hidden" id="J_From" name="from" value="tmall" />
                ...
                <input type="hidden" name="newMini2" value="true" />
                ...
                <input type="hidden" id="J_sub" name="sub" value="true" />
                ...
                <input type="hidden" id="J_allp" name="allp" value="assets_css=3.0.10/login_pc.css" />
                <input type="hidden" name="oslanguage" value="zh-CN" />
                <input type="hidden" name="sr" value="1536*864" />
                <input type="hidden" name="osVer" />
                <input type="hidden" name="naviVer" value="chrome|79.0394513" />
                <input type="hidden" name="osACN" value="Mozilla" />
                <input
                  type="hidden"
                  name="osAV"
                  value="5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.130 Safari/537.36"
                />
                <input type="hidden" name="osPF" value="Win32" />
                ...
                <input
                  ...
                  value="https://login.taobao.com/member/login.jhtml?tpl_redirect_url=https://www.tmall.com/&amp;style=miniall&amp;enup=true&amp;newMini2=true&amp;full_redirect=true&amp;sub=true&amp;from=tmall&amp;allp=assets_css=3.0.10/login_pc.css&amp;pms=1579938581928&amp;useMobile=true"
                />
              ...
              <ul class="entries">
                <li id="J_OtherLogin" class="other-login"></li>
              </ul>

              <div class="login-links">
                <a tabindex="6" class="forget-pwd" target="_blank">忘记密码</a>

                <a target="_blank">忘记会员名</a>

                <a class="register" target="_blank" tabindex="7">免费注册</a>
              </div>
              <input
                type="hidden"
                name="um_token"
                value="T8621A23C6CD0D4DF5A3CEB6377105C062753352C6402A06DFBC7B80409"
              />
            </form>
          </div>
          ...
          <div class="quick-form">
            <!--扫码登录开始-->
            <div class="qrcode-login" id="J_QRCodeLogin" style="display: block;">
              ...
              <div class="qrcode-mod">
                <div class="qrcode-main">
                  <div class="qrcode-img" id="J_QRCodeImg" style="opacity: 1; left: 80px;">
                    <img src="//img.alicdn.com/imgextra/O1CN01HPwSk228CsJZVzt5k_!!7897-2-xcode.png" />
                  </div>
                ...
                <div class="qrcode-desc" data-spm="25847036">
                  ...
                  <p>
                    <font class="ft-gray">打开</font>
                    <a
                      href="https://www.tmall.com/wow/portal/act/app-download?mmstat=pc_login"
                      target="_blank"
                      class="light-link"
                    >手机天猫</a> |
                    <a href="https://www.taobao.com/m" target="_blank" class="light-link">手机淘宝</a>
